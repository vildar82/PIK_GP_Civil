...
namespace PIK_GP_Civil.TEP.Balance
{
    class BalanceService : CreateTable, ITableService
    {
        ...
        static List<ClassType> classTypes = new List<ClassType>() {
             new ClassType(HomeArea, "Площадь участка дома", null, 0, "м2"),
             new ClassType("Размещаемые БРП_ТП", "Площадь размещаемой БРП, ТП", null, 1, "м2"),
             new ClassType("Жилые здания", "Площадь застройки дома", null, 2, "м2"),
             new ClassType("Общественные здания", "Площадь застройки дома", null, 2, "м2"),
             new ClassType("Асфальтобетон", "Площадь проектируемых проездов и автостоянок с покрытием асфальтобетоном", ClassGroup.HardCoating, 3, "м2"),
             new ClassType("Тротуарная плитка_Тротуары", "Прощадь проектируемых троутаров с покрытием тротуарной плиткой", ClassGroup.HardCoating, 4, "м2"),
             new ClassType("Тротуарная плитка_Тротуары с проездом", "Площадь проектируемых усиленных тротуаров с покрытием тротуарной плиткой с возможностью проезда пожарного автотранспорта", ClassGroup.HardCoating, 5, "м2"),
             new ClassType("Газон", "Площадь газонов", ClassGroup.Landscaping, 6, "м2"),
             new ClassType("Газон_отмостка", "Площадь отмостки с газонным покрытием", ClassGroup.Landscaping, 7, "м2"),
             new ClassType("Гравийные высевки_ДП", "Детские игровые площадки с покрытием гравийными высевками", ClassGroup.Landscaping, 8, "м2"),
             new ClassType("Гравийные высевки_ПО", "Площадки отдыха взрослого населения с покрытием гравийными высевками", ClassGroup.Landscaping, 9, "м2"),
             new ClassType("Гравийные высевки_ПАО", "Площадка активного отдыха гравийными высевками", ClassGroup.Landscaping, 10, "м2"),
             new ClassType("Газонная решетка_Проезд пож.транспорта", "Площадь проездов пожарного автотранспорта с покрытием газонной решеткой", ClassGroup.Landscaping, 11, "м2")
        };
